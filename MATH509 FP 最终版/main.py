...
if __name__ == "__main__":
    # 设置图像路径
    image_name = "/Users/ec/Desktop/MATH509 FP 算法预处理/unsplash_images/processed/unsplash_iNp-szjoqT8.tif"
    oimage = Image.open("/Users/ec/Desktop/MATH509 FP 算法预处理/unsplash_images/original/unsplash_iNp-szjoqT8.tif")
    ...
    # TOL=0.5 所有算法效果极佳
    # TOL=0.1 才可以观察出区别
    im_rec = inpainter_gmm.inpaint(image_name, fill_rgb, spacing, width, l2_coef, tolerance)
